            ...
            <div class="modal-dialog modal-fullscreen">
                <div class="modal-content rounded-0">
                    ...
                    <div class="modal-body d-flex align-items-center">
                        <form action="category.php?" method = "GET" class="input-group w-75 mx-auto d-flex">
                        <input type="hidden" name="category" value="<?php echo isset($kategori) ? $kategori : ''; ?>">
            ...
            <div class="container py-5">
                ...
                <div class="row g-4">
                    <div class="col-lg-12">
                        <div class="row g-4">
                            <div class="col-xl-3">
                                <form action="category.php?" method = "GET" class="input-group w-100 mx-auto d-flex">
                                    <input type="hidden" name="category" value="<?php echo isset($kategori) ? $kategori : ''; ?>">
                                ...
                                <?php 
                                 ...
                                 if(isset($_POST['sort'])){
                                    ...
                                    if(isset($_GET['cari'])){ //mendapatkan kata kunci dari method get
                                        ...
                                        WHERE resep.judul LIKE '%" . $cari ."%' OR user.name LIKE '%". $cari ."%' AND kategori.nama = '$kategori'
                                        ...
                                        INNER JOIN user ON user.id=resep.user_id
                                        INNER JOIN kategori ON kategori.id = resep.kategori_id
                                        WHERE judul LIKE '%" . $cari ."%' OR name LIKE '%". $cari ."%' AND kategori.nama = '$kategori'
                                        ORDER BY $urut ";
                                        ?>  
                                        ...
                                        <div class="pagination d-flex justify-content-center mt-5">
                                            ...
                                            if($jumlah_halaman > 1){
                                                ...
                                                if(isset($_GET['cari'])){
                                                    ...
                                                    if($halaman > 1){ ?>
                                                        <a <?php if($halaman > 1) { echo "href='?category=$kategori&cari=$cari&page=$previous'";} ?> class="rounded">&laquo;</a>
                                                        <a href="<?php echo"?category=$kategori&page=1"; ?>" class="rounded " >1</a>
                                                <?php } ?>
                                                ...
                                                <?php 
                                                    if($halaman < $jumlah_halaman){ ?>
                                                        <a <?php echo "href='?category=$kategori&cari=$cari&page=$jumlah_halaman'"; ?> class="rounded"><?php echo $jumlah_halaman; ?></a>
                                                        <a <?php echo "href='?category=$kategori&cari=$cari&page=$next'";  ?> class="rounded">&raquo;</a>
                                                <?php }   

                                                }else{
                                                    
                                                    if($halaman > 1){ ?>
                                                        <a <?php if($halaman > 1) { echo "href='?category=$kategori&page=$previous'";} ?> class="rounded">&laquo;</a>
                                                        <a href="<?php echo"?category=$kategori&page=1"; ?>" class="rounded " >1</a>
                                                <?php } ?>
                                                ...
                                                <?php 
                                                    if($halaman < $jumlah_halaman){ ?>
                                                        <a href="<?php echo "?category=$kategori&page=$jumlah_halaman"; ?>" class="rounded"><?php echo $jumlah_halaman; ?></a>
                                                        <a <?php  echo "href='?category=$kategori&page=$next'" ?> class="rounded">&raquo;</a>
                                                <?php 
                                                    }
                                                }
                                        } ?>
